...
OUTPUT_FILE = "/home/knightbaron/data/data_1hz.csv.gz"
OUTPUT_FILE_NOIP = "/home/knightbaron/data/data_1hz_noip.csv.gz"
OUTPUT_FILE_NOMETA = "/home/knightbaron/data/data_1hz_nometa.csv.gz"
...
if __name__ == "__main__":
    ...
    with gzip.open(OUTPUT_FILE, "wb") as output_file,\
        ...
        for (identifier, packets) in flows.iteritems():  # Loop through each (noised) flow
            ...
            for packet in packets:
                ...
                while window <= last_window:
                    ...
                    try:
                        ...
                        counter_windows[window][sample_index] += 1
            ...
            for window, counter_window in izip(windows, counter_windows):
                writer.writerow(
                    (
                    ...
                    ) + tuple(window) + tuple(counter_window)
                )
                ...
                writer_nometa.writerow(tuple(window) + tuple(counter_window))
            # output_file.flush()
