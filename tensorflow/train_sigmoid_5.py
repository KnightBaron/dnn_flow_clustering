...
MODEL_FILE = "/work/pongsakorn-u/tensorflow_model/sigmoid/{}outputs/model".format(N_HIDDEN_3)
LOG_PATH = "/work/pongsakorn-u/tensorflow_log/sigmoid/{}outputs".format(N_HIDDEN_3)
