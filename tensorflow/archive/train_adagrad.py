...
TOTAL_EPOCHS_LAYER1 = 3001
TOTAL_EPOCHS_LAYER2 = 3001
TOTAL_EPOCHS_LAYER3 = 3001
LEARNING_RATE = 0.01  # Adagrad's default learning rate
BATCH_SIZE = 10
...
META_GRAPH_FILE = "/work/pongsakorn-u/tensorflow_model/adagrad/my-model.meta"
MODEL_FILE = "/work/pongsakorn-u/tensorflow_model/adagrad/my-model"
LOG_PATH = "/work/pongsakorn-u/tensorflow_log/adagrad"
...
if __name__ == "__main__":
    ...
    train_layer_1 = tf.train.AdagradOptimizer(learning_rate=LEARNING_RATE).minimize(
    ...
    train_layer_2 = tf.train.AdagradOptimizer(learning_rate=LEARNING_RATE).minimize(
    ...
    train_layer_3 = tf.train.AdagradOptimizer(learning_rate=LEARNING_RATE).minimize(
