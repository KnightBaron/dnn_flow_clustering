...
META_GRAPH_FILE = "/work/pongsakorn-u/tensorflow_model/deep_softmax/my-model.meta"
MODEL_FILE = "/work/pongsakorn-u/tensorflow_model/deep_softmax/my-model"
LOG_PATH = "/work/pongsakorn-u/tensorflow_log/deep_softmax"
...
if __name__ == "__main__":
    with tf.name_scope("input_pipeline"):
        ...
        noised_examples_batch, cleaned_examples_batch = tf.train.shuffle_batch(
            [noised_examples, cleaned_examples], batch_size=BATCH_SIZE, capacity=CAPACITY,
