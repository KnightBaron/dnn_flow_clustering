...
META_GRAPH_FILE = "/work/pongsakorn-u/tensorflow_model/sgd/my-model.meta"
MODEL_FILE = "/work/pongsakorn-u/tensorflow_model/sgd/my-model"
LOG_PATH = "/work/pongsakorn-u/tensorflow_log/sgd"
...
if __name__ == "__main__":
    ...
    train_layer_1 = tf.train.GradientDescentOptimizer(learning_rate=LEARNING_RATE).minimize(
    ...
    train_layer_2 = tf.train.GradientDescentOptimizer(learning_rate=LEARNING_RATE).minimize(
    ...
    train_layer_3 = tf.train.GradientDescentOptimizer(learning_rate=LEARNING_RATE).minimize(
