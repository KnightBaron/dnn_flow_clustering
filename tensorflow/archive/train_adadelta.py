...
TOTAL_EPOCHS_LAYER1 = 1001
TOTAL_EPOCHS_LAYER2 = 1001
TOTAL_EPOCHS_LAYER3 = 1001
LEARNING_RATE = 1.0  # Adadelta's default learning rate
BATCH_SIZE = 10
...
META_GRAPH_FILE = "/work/pongsakorn-u/tensorflow_model/adadelta/my-model.meta"
MODEL_FILE = "/work/pongsakorn-u/tensorflow_model/adadelta/my-model"
LOG_PATH = "/work/pongsakorn-u/tensorflow_log/adadelta"
...
if __name__ == "__main__":
    ...
    train_layer_1 = tf.train.AdadeltaOptimizer(learning_rate=LEARNING_RATE).minimize(
    ...
    train_layer_2 = tf.train.AdadeltaOptimizer(learning_rate=LEARNING_RATE).minimize(
    ...
    train_layer_3 = tf.train.AdadeltaOptimizer(learning_rate=LEARNING_RATE).minimize(
