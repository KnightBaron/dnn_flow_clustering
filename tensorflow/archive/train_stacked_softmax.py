...
META_GRAPH_FILE = "/work/pongsakorn-u/tensorflow_model/stacked_softmax_24000x3/my-model.meta"
MODEL_FILE = "/work/pongsakorn-u/tensorflow_model/stacked_softmax_24000x3/my-model"
LOG_PATH = "/work/pongsakorn-u/tensorflow_log/stacked_softmax_24000x3"
...
if __name__ == "__main__":
    ...
    train_layer_1 = tf.train.RMSPropOptimizer(learning_rate=LEARNING_RATE).minimize(
    ...
    train_layer_2 = tf.train.RMSPropOptimizer(learning_rate=LEARNING_RATE).minimize(
    ...
    train_layer_3 = tf.train.RMSPropOptimizer(learning_rate=LEARNING_RATE).minimize(
